...
public class AddRBinaryExpressionImpl extends ASTWrapperPsiElement implements AddRBinaryExpression {

  public AddRBinaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
